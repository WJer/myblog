...
//遍历所有md文档
function eachSourceMdFile(sourceDir, callback) {
...
function loadConfig(dir) {
	var configDir = path.resolve(dir, 'config.json');
	return JSON.parse(fs.readFileSync(configDir).toString());
}

module.exports = {
	renderIndex: renderIndex,
	renderPost: renderPost,
	eachSourceMdFile: eachSourceMdFile,
	stripExtname: stripExtname,
